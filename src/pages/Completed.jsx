                ...
                <div className="absolute top-0 left-0 w-full h-[260px] md:h-[649px] text-white text-xl font-bold">
                    <div className="flex w-full h-[80px] items-center justify-around">
                        ...
                        <ul className="flex text-sm font-normal">
                            ...
                            <Link to="/"><li className="mx-[10px] cursor-pointer hover:opacity-90">Contact Us</li></Link>
                        </ul>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-2 justify-items-center">
                        <div className="py-10">
                            <div className='bg-white rounded overflow-hidden shadow-lg max-w-sm transform transition duration-500 hover:scale-110' >
                                ...
                                <div className='font-bold text-3xl mb-2 text-center text-black'>Flutter Development</div>
                                <div className='font-bold text-xl mb-2 text-center text-black'>Progress :- 100%</div>
                                <div className='m-[25px]'>
                                    <span><ProgressBar completed={100} /></span>
                                </div>
                                <Link to="/Flutter"><button className="bg-transparent hover:bg-black text-black font-semibold hover:text-white py-2 px-4 mt-3 border border-black hover:border-transparent rounded ml-[16px] mb-[8px]" >Go To Course</button></Link>
                            </div>
                        </div>
                        <div className="py-10">
                            <div className='bg-white rounded overflow-hidden shadow-lg max-w-sm transform transition duration-500 hover:scale-110' >
                                <img src={Cloud} alt='Power BI' className='w-full' />
                                <div className='font-bold text-3xl mb-2 text-center text-black'>AWS Fundamentals</div>
                                <div className='font-bold text-xl mb-2 text-center text-black'>Progress :- 100%</div>
                                <div className='m-[25px]'>
                                    <span><ProgressBar completed={100} /></span>
                                </div>
                                <Link to="/AWS"><button className="bg-transparent hover:bg-black text-black font-semibold hover:text-white py-2 px-4 mt-3 border border-black hover:border-transparent rounded ml-[16px] mb-[8px]" >Go To Course</button></Link>
                            </div>
                        </div>
                        <div className="py-10">
                            <div className='bg-white rounded overflow-hidden shadow-lg max-w-sm transform transition duration-500 hover:scale-110' >
                                <img src={DataAnalysis} alt='Power BI' className='w-full' />
                                <div className='font-bold text-3xl mb-2 text-center text-black'>Power BI From Scratch</div>
                                <div className='font-bold text-xl mb-2 text-center text-black'>Progress :- 100%</div>
                                <div className='m-[25px]'>
                                    <span><ProgressBar completed={100} /></span>
                                </div>
                                <Link to="/Azure"><button className="bg-transparent hover:bg-black text-black font-semibold hover:text-white py-2 px-4 mt-3 border border-black hover:border-transparent rounded ml-[16px] mb-[8px]" >Go To Course</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
