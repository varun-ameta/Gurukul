                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-2 justify-items-center">
                        <div className="py-10">
                            <div className='bg-white rounded overflow-hidden shadow-lg max-w-sm transform transition duration-500 hover:scale-110' >
                                ...
                                <Link to="/React"><button className="bg-transparent hover:bg-black text-black font-semibold hover:text-white py-2 px-4 mt-3 border border-black hover:border-transparent rounded ml-[16px] mb-[8px]" >Continue</button></Link>
                            </div>
                        </div>
                        <div className="py-10">
                            <div className='bg-white rounded overflow-hidden shadow-lg max-w-sm transform transition duration-500 hover:scale-110' >
                                ...
                                <Link to="/Next"><button className="bg-transparent hover:bg-black text-black font-semibold hover:text-white py-2 px-4 mt-3 border border-black hover:border-transparent rounded ml-[16px] mb-[8px]" >Continue</button></Link>
                            </div>
                        </div>
                        <div className="py-10">
                            <div className='bg-white rounded overflow-hidden shadow-lg max-w-sm transform transition duration-500 hover:scale-110' >
                                ...
                                <Link to="/AICourse"><button className="hover:bg-black text-black font-semibold hover:text-white py-2 px-4 mt-3 border border-black hover:border-transparent rounded ml-[16px] mb-[8px]" >Continue</button></Link>
                            </div>
                        </div>
                    </div>
                    <div className='md:flex md:items-center md:justify-evenly'><Link to="/courses-completed"><button className="bg-white hover:bg-black text-black font-semibold hover:text-white py-2 px-4 mt-3 border border-black hover:border-transparent rounded " >Completed Courses</button></Link></div>
                </div>
            </header>
            <Footer />
        </>
